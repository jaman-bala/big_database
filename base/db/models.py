...
class Db(models.Model):
    ...
    pin_bank = models.CharField(max_length=255, unique=True, null=True, verbose_name="Номер карточки банка")
    erp = models.TextField(verbose_name="Номер ЕРП")
    image = models.FileField(upload_to='media', blank=True, verbose_name="Прикрепить файл")
    image1 = models.FileField(upload_to='media', blank=True, verbose_name="Копия паспорта")
    image2 = models.FileField(upload_to='media', blank=True, verbose_name="Вставить файл")
    ...
    class Meta:
        ...
        verbose_name_plural = "Добавить данные для Банка"
        ordering = ["-created"]
